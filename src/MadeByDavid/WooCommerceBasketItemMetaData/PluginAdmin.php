...
class PluginAdmin {
    ...
    const ADMIN_SCRIPT_ID = 'madebydavid-woocommercebasketitemmetadata-admin-javascript';
    const ADMIN_AJAX_ACTION = 'madebydavid-woocommercebasketitemmetadata-admin-ajax-action';
    ...
    function registerAdminMenu() {
        $optionsPage = add_submenu_page(
            'woocommerce',
            __( 'Basket Item Meta Data', Plugin::TRANSLATE_DOMAIN),
            __( 'Basket Item Meta Data', Plugin::TRANSLATE_DOMAIN),
            'manage_woocommerce',
    ...
    function registerAdminCss() {
        echo '<link rel="stylesheet" type="text/css" href="'.WOOCOMMERCE_BASKETITEMMETADATA_URL.'css/admin.css"></link>';
    }
    
    function registerAdminJavascript() {
        wp_register_script(
            self::ADMIN_SCRIPT_ID,
            WOOCOMMERCE_BASKETITEMMETADATA_URL . 'js/admin.js',
            array('jquery')
        );
    }
    ...
    public function showAdminOptions() {
        ...
        include WOOCOMMERCE_BASKETITEMMETADATA_DIR . '/templates/admin-options.php';
    }
